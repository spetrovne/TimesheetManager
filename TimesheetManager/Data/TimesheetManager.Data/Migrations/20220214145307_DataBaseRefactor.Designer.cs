...
namespace TimesheetManager.Data.Migrations
{
    ...
    [Migration("20220214145307_DataBaseRefactor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimesheetManager.Data.Models.Week", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimesheetManager.Data.Models.Timesheet", b =>
                {
                    b.HasOne("TimesheetManager.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Timesheets")
            ...
            modelBuilder.Entity("TimesheetManager.Data.Models.Week", b =>
                {
                    b.HasOne("TimesheetManager.Data.Models.Timesheet", "Timesheet")
                        .WithOne("Week")
                        .HasForeignKey("TimesheetManager.Data.Models.Week", "TimesheetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
