namespace TimesheetManager.Services.Data.Timesheet
{
    ...
    public class TimesheetService : ITimesheetService
    {
        ...
        {
            var isProductValid = await this.projectService.ValidateProject(model.ProjectId);
            ...
            var isTaskValid = await this.projectService.ValidateProject(model.TaskId);
            ...
            var user = await this.userManager.FindByEmailAsync(model.UserEmail);
            ...
            await this.weekService.CreateAsync(week);
